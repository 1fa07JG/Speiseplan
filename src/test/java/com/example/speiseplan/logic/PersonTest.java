...
class PersonTest {
    ...
    public Meal lunch0 = new Meal("Fasan im Federkleid");
    public Meal lunch1 = new Meal("Knödel in Schokoladen Soße");
    public Meal lunch2 = new Meal("Fish and Chips");
    public Meal lunch3 = new Meal("Bratkartoffeln");
    public Meal lunch4 = new Meal("Schwan im Federkleid");
    public Meal lunch5 = new Meal("Risotto");
    public Meal lunch6 = new Meal("Hirschrücken mit chili garniert");
    public Meal lunch7 = new Meal("Zuckerschloss");
    public Meal lunch8 = new Meal("Pastete vom Narwhal");
    public Meal lunch9 = new Meal("Kaiserschmarrn");
